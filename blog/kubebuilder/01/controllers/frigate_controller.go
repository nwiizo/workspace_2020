...
import (
	...
	shipv1beta1 "kubebuilder-test-controller/api/v1beta1"
)
...
// +kubebuilder:rbac:groups=ship.nwiizo.dev,resources=frigates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ship.nwiizo.dev,resources=frigates/status,verbs=get;update;patch
